...
<body>
    ...
    <div class="row mt-5 mx-auto p-2" style="width: 800px;">
      ...
      <div class="col-6">
          <form action="/addaccountants" method="post">
            ...
            <br>
              ...
              <div class="form-group">
                ...
                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="accountantemail" value="" required autocomplete="email">
              ...
              <div class="form-group">
                ...
                <input id="contact_no" type="contact_no" class="form-control @error('contact_no') is-invalid @enderror" name="contact_no" value="{{ old('contact_no') }}" required >
