...
<body>
    ...
    <div class="row mt-5 mx-auto p-2" style="width: 800px;">
      ...
      <div class="col-6">
          <form action="/update_permission/{{ $roles[0]["id"]}}" method="post">
            {{-- class="mt-5 mx-auto p-2" style="width: 200px;" --}}
            @csrf
            <p><b>Edit Permission</b></p>
            <div class="form-group">
              <label for="exampleInputEmail1"> Role</label>
              <input id="role" type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ $roles[0]["role"] }}" required autocomplete="name" autofocus>
